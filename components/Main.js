...
export default class App extends React.Component {
  ...
  render() {
    if(this.state.camera){
      ...
      else if(this.state.action == 'findpers'){
        return (
          <View style={{ flex: 1 }}>
              <Spinner
                visible={this.state.loading}
                  ...
                  <View style={{
                    ...
                    <TouchableOpacity style={{
                      ...
                      <LinearGradient
                        ...
                        <View style={{ flex: 3, width: '100%', justifyContent: 'center', alignItems: 'center' }}>
                          <Text style={{ fontWeight: 'bold', fontSize: Math.min(12.5 * rem, 22.5 * wid) }}>Find A Person</Text>
                        </View>
                      </LinearGradient>
                    </TouchableOpacity>
                  </View>
                  ...
                  <View style={{
                    ...
                    <TouchableOpacity style={{
                      ...
                      <LinearGradient
                        ...
                        <View style={{ flex: 3, width: '100%' }}>
                          <Text style={{ fontWeight: 'bold', fontSize: Math.min(12.5 * rem, 22.5 * wid) }}>Find an Object</Text>
                  ...
                  <View style={{
                    ...
                    <TouchableOpacity style={{
                      ...
                      <LinearGradient
                        ...
                        <View style={{ flex: 3, width: '100%' }}>
                          <Text style={{ fontWeight: 'bold', fontSize: Math.min(12.5 * rem, 22.5 * wid) }}>Memory Game</Text>
                  ...
                  <View style={{
                    ...
                    <TouchableOpacity style={{
                      ...
                      <LinearGradient
                        ...
                        <View style={{ flex: 3, width: '100%' }}>
                          <Text style={{ fontWeight: 'bold', fontSize: Math.min(12.5 * rem, 22.5 * wid) }}>Person Trivia</Text>
